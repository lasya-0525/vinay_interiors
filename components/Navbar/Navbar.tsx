...
export default function Navbar() {
  ...
  const isDarkPage = pathname === "/" || pathname === "/projects" || pathname === "/services" || pathname === "/gallery" || pathname === "/about" || pathname === "/contact";
  ...
  return (
    ...
    >
      <nav
        className="px-5 py-4 md:px-10 md:py-6 flex justify-center md:justify-between items-center relative"
        style={{
          maxWidth: "1280px",
          margin: "0 auto",
